//importação de temas claro/escuro e theme provider para gerar os componentes do app
import {
  DarkTheme,
  ThemeProvider
...
// só será então escondida manualmente quando os recursos terminarem de carregar
